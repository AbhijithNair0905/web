            ...
            <div className="col-xl-12 col-lg-12">
              <SlideUp>
                <div className="section-title text-center">
                  ...
                  <p>
                    Check out my design work—a mashup of motion graphics,
                    illustration, branding, video editing, and 3D skills, all
                    crafted with a mix of dedication, caffeine, and a borderline

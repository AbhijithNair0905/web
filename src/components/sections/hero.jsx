          ...
          <div className="col-lg-4">
            <SlideUp>
              <div className="about-image-part">
                ...
                <h2>Abhijith Nair</h2>
                <p>
                  Mumbai-based designer skilled in graphic design, motion
                  graphics, branding, and 3D animation.
                </p>
          ...
          <div className="col-lg-8">
            <SlideUp>
              <div className="about-content-part">
                <p>Hello There!</p>
                <h2>
                  I’m Abhijith Nair, designer skilled in graphic design, motion
                  graphics, branding, and 3D animation. I bring bold ideas to
                  life—because nobody likes boring.
                </h2>
